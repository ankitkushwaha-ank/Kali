...
import { displayfilemanager } from './components/apps/filemanager';
...
const apps = [
    ...
    },
    {
        id: "ikon",
        title: "Ikon",
        icon: './themes/Flat-Remix-Blue-Dark/apps/ikon.png',
        disabled: false,
        favourite: false,
        desktop_shortcut: false,
        screen: displayikon,
    },
    {
        id: "buzzi",
        title: "Buzzi",
        icon: './themes/Flat-Remix-Blue-Dark/apps/buzzi.png',
        disabled: false,
        favourite: false,
        desktop_shortcut: false,
        screen: displaybuzzi,
